...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    governanceModule: {
      ...
      legitWhitelist: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u8>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    subnetEmissionModule: {
      emissionLoweringBlock: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      originalUnitEmission: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
    ...
    subspaceModule: {
      ...
      adjustmentAlpha: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<u64>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      ...
      burnConfig: AugmentedQuery<ApiType, () => Observable<PalletSubspaceGlobalBurnConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
      ...
      maxRegistrationsPerInterval: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<u16>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      ...
      minImmunityStake: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<u64>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      ...
      subnetBurnConfig: AugmentedQuery<ApiType, () => Observable<PalletSubspaceGlobalSubnetBurnConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
      ...
      targetRegistrationsInterval: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<u16>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      targetRegistrationsPerInterval: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<u16>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
