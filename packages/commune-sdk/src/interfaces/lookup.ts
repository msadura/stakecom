...
export default {
  ...
  PalletSubspaceGlobalParams: {
    ...
    burnConfig: 'PalletSubspaceGlobalBurnConfiguration',
    governanceConfig: 'PalletGovernanceApiGovernanceConfiguration',
    kappa: 'u16',
    rho: 'u16'
  },
  /**
   * Lookup49: pallet_subspace::global::BurnConfiguration<T>
   **/
  PalletSubspaceGlobalBurnConfiguration: {
    minBurn: 'u64',
    maxBurn: 'u64'
  },
  /**
   * Lookup50: pallet_governance_api::GovernanceConfiguration
   **/
  ...
  /**
   * Lookup51: pallet_governance_api::VoteMode
   **/
  PalletGovernanceApiVoteMode: {
    _enum: ['Authority', 'Vote']
  },
  /**
   * Lookup52: pallet_governance::pallet::Event<T>
   **/
  ...
  /**
   * Lookup53: pallet_subnet_emission::pallet::Event<T>
   **/
  ...
  /**
   * Lookup54: pallet_base_fee::pallet::Event
   **/
  PalletBaseFeeEvent: {
    _enum: {
      NewBaseFeePerGas: {
  ...
  /**
   * Lookup65: frame_system::CodeUpgradeAuthorization<T>
   **/
  ...
  /**
   * Lookup86: sp_consensus_aura::sr25519::app_sr25519::Public
   **/
  SpConsensusAuraSr25519AppSr25519Public: '[u8;32]',
  /**
   * Lookup89: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup90: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup95: sp_consensus_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup96: sp_consensus_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup97: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup99: sp_consensus_grandpa::app::Signature
   **/
  SpConsensusGrandpaAppSignature: '[u8;64]',
  /**
   * Lookup102: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup103: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup106: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup108: pallet_balances::types::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup109: pallet_balances::types::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup112: pallet_balances::types::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup115: pallet_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup129: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
  ...
  /**
   * Lookup133: node_subspace_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup135: pallet_subspace::pallet::Call<T>
   **/
  PalletSubspaceCall: {
    _enum: {
      set_weights: {
  ...
  /**
   * Lookup141: pallet_governance::pallet::Call<T>
   **/
  ...
  /**
   * Lookup142: pallet_base_fee::pallet::Call<T>
   **/
  PalletBaseFeeCall: {
    _enum: {
  ...
  /**
   * Lookup145: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup147: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
  ...
  /**
   * Lookup156: pallet_subspace::global::SubnetBurnConfiguration<T>
   **/
  PalletSubspaceGlobalSubnetBurnConfiguration: {
    minBurn: 'u64',
    maxBurn: 'u64',
    adjustmentAlpha: 'u64',
    adjustmentInterval: 'u16',
    expectedRegistrations: 'u16',
    maxRegistrations: 'u16'
  },
  /**
   * Lookup157: frame_support::PalletId
   **/
  FrameSupportPalletId: '[u8;8]',
  /**
   * Lookup158: pallet_subspace::pallet::Error<T>
   **/
  PalletSubspaceError: {
  ...
  /**
   * Lookup159: pallet_governance::proposal::Proposal<T>
   **/
  ...
  /**
   * Lookup160: pallet_governance::proposal::ProposalData<T>
   **/
  ...
  /**
   * Lookup161: pallet_subspace::pallet::SubnetParams<T>
   **/
  ...
  /**
   * Lookup162: pallet_governance::proposal::ProposalStatus<T>
   **/
  ...
  /**
   * Lookup165: pallet_governance::proposal::UnrewardedProposal<T>
   **/
  ...
  /**
   * Lookup170: pallet_governance::dao::CuratorApplication<T>
   **/
  ...
  /**
   * Lookup171: pallet_governance::dao::ApplicationStatus
   **/
  PalletGovernanceDaoApplicationStatus: {
    _enum: ['Pending', 'Accepted', 'Refused']
  },
  /**
   * Lookup172: pallet_governance::pallet::Error<T>
   **/
  ...
  /**
   * Lookup173: pallet_subnet_emission_api::SubnetConsensus
   **/
  ...
  /**
   * Lookup178: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup179: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup180: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup181: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup184: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup185: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup186: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u64>',
  /**
   * Lookup188: node_subspace_runtime::Runtime
   **/
