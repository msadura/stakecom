...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    subspaceModule: {
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      floorDelegationFee: AugmentedQuery<
        ApiType,
        () => Observable<Percent>,
        []
      > &
      ...
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      maxAllowedModules: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      maxAllowedSubnets: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      maxAllowedWeights: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<u16>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      maxAllowedWeightsGlobal: AugmentedQuery<
        ApiType,
        () => Observable<u16>,
        []
      > &
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      maxStake: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<u64>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      maxWeightAge: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<u64>,
        [u16]
      > &
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      minStakeGlobal: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      minWeightStake: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      n: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<u16>,
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      profitShares: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Vec<ITuple<[AccountId32, u16]>>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      registrationBlock: AugmentedQuery<
        ApiType,
        (
          arg1: u16 | AnyNumber | Uint8Array,
          arg2: u16 | AnyNumber | Uint8Array,
      ...
      > &
        QueryableStorageEntry<ApiType, [u16, u16]>;
      registrationsPerBlock: AugmentedQuery<
        ApiType,
        () => Observable<u16>,
        []
      > &
      ...
      > &
        QueryableStorageEntry<ApiType, [u16, AccountId32]>;
      subnetEmission: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<u64>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      subnetNames: AugmentedQuery<
        ApiType,
      ...
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      totalSubnets: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
